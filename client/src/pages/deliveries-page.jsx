...
export default function DeliveriesPage() {
  ...
  return <><PageHeader title="Delivery manifest" description="Search, filter and inspect the authoritative delivery record." action={user.role === 'customer'&&<Link className="button" to="/deliveries/new"><Plus/> New request</Link>}/>

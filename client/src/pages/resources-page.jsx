  ...
  return <>
    ...
    {isAdmin && <section className="panel user-admin">
      ...
      <form className="account-create-form" onSubmit={createAccount}>
        ...
        <label>Role<select value={accountForm.role} onChange={(event) => setAccountForm({ ...accountForm, role: event.target.value })}><option value="customer">Customer</option><option value="driver">Driver</option><option value="manager">Manager</option><option value="admin">Admin</option></select></label>
